...
# A = list(map(float, ('5 1 1 2 90 1 2 2 90 1 1 2 180 1 1 3 90 1 1 3 90 1 1 2 90 1 1 4 2 90 1 2').split()))
# print_code(A, 30)
index = (9, 4, 1, 7, 0, 0)
# index = (1, 2, 3, 4, 5, 6)
# index = (6, 7, 8, 9, 0, 1)
...
# print_code('5 1 1 2 90 1 2 2 90 1 1 2 180 1 1 3 90 1 1 3 90 1 1 2 90 1 1 4 2 90 1 2', 30)
# one print('4 2 90 1 1 3 135 5 1 1.414215624 2 135 1 2 4 3 90 1 1 3 90 1 2 2 90')
# two print('5 1 1 2 90 1 1 2 90 1 1 3 90 1 1 3 90 1 1 4 1 1 3 90 1 2 2 90')
# three print('5 1 1 2 90 1 1 2 90 1 1 2 180 1 1 2 90 1 1 2 90 1 1 4 2 180 1 2 3 90 1 2 3 90')
# four print('5 2 90 1 1 3 90 1 1 3 90 1 1 3 180 1 2 3 90 4 1 1 3 90 1 2 2 90')
# five print('1 1 2 180 5 1 1 3 90 1 1 3 90 1 1 2 90 1 1 2 90 1 1 4 2 180 1 2 3 90 1 2 2 90')
# six print('1 1 2 180 5 1 1 3 90 1 1 3 90 1 1 2 90 1 1 2 90 1 1 2 90 1 1 4 2 90 1 2 3 90 1 1 2 90')
# seven print('5 1 1 2 135 1 1.414215624  3 45 1 1 4 3 90 1 2 3 90 1 2 2 90')
# eight print('5 1 1 2 90 1 2 2 90 1 1 2 90 1 1 2 90 1 1 2 180 1 1 2 90 1 1 4 2 90 1 2')
# nine print('5 1 1 2 90 1 2 2 90 1 1 2 180 1 1 3 90 1 1 3 90 1 1 2 90 1 1 4 2 90 1 2')
# zero print('5 1 1 2 90 1 2 2 90 1 1 2 90 1 2 4 2 90 1 2')
# print_code([4, 2, 90, 1, 1, 3, 135, 5, 1, 1.414215624, 2, 135, 1, 2, 4, 3, 90, 1, 1, 3, 90, 1, 2, 2, 90], 30)
# A = list(map(float, ('5 1 1 2 90 1 2 2 90 1 1 2 180 1 1 3 90 1 1 3 90 1 1 2 90 1 1 4 2 90 1 2').split()))
# print_code(A, 30)
